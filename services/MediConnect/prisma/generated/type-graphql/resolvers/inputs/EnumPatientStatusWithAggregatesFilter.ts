...
import { NestedEnumPatientStatusWithAggregatesFilter } from "../inputs/NestedEnumPatientStatusWithAggregatesFilter";
import { NestedIntFilter } from "../inputs/NestedIntFilter";
import { PatientStatus } from "../../enums/PatientStatus";

@TypeGraphQL.InputType("EnumPatientStatusWithAggregatesFilter", {
  isAbstract: true
})
export class EnumPatientStatusWithAggregatesFilter {
